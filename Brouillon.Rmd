...
Thus, voters with a higher level of political knowledge and interest should be more inclined to use information seeking media such as the Polimeter. The Polimeter is a campaign pledge evaluation tool (CPET) that tracks the electoral promises of ruling parties (Tremblay-Antoine et al., 2020; Trudeau Polimeter, 2015).
